...
public class NowWidgetTest extends WidgetTestCase {
    ...
    public void test_noPattern() throws Exception {
        String errorMessage = HtmlUtil.metaText("!now MM/dd/yyyy<br/>Bad syntax!<br/>Options:<br/><ul></ul>");
        
        assertEquals(errorMessage, widget("!now MM/dd/yyyy", "01/01/2000").render());
    }
